...
-- Code generation timestamp: (2025-11-05 22:58:23.906538)
...
begin
    ...
    with schedule_cnt select
        value <=
            b"11100001" when "0101",
            b"10101001" when "0100",
            b"00111011" when "1001",
            b"10001110" when "0111",
            b"00001100" when "0001",
            b"10001110" when "0000",
            b"10001110" when "0011",
            b"11100101" when "0010",
            b"11000101" when "1000",
            b"11110111" when "0110",
            b"10101001" when "1010",
            (others => '-') when others;
